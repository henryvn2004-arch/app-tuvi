...
427 mục ghi chép từng PR, tách khỏi `CLAUDE.md` để nó thôi ngốn ~350k token mỗi lượt.
...
| 1 | 2026-09 | `2026-09.md` | 🧭 Lăng kính chủ đề cho Kỳ Môn — lọc cửa/sao/thần theo `nghia` sẵn có |
| 1 | 2026-09 | `2026-09.md` | 🧹 Dọn 3 mục nhẹ còn treo từ đợt `ux-tester` — không phải công thức cổ pháp |
...
| 1 | 2026-09 | `2026-09.md` | 🗓️ Luận theo chủ đề — lăng kính cho HẠN THÁNG và HẠN NGÀY |
| 1 | 2026-09 | `2026-09.md` | 🔀 Luận theo chủ đề — câu hỏi HAI trọng tâm ("tiền và sức khỏe năm nay") |
| 1 | 2026-09 | `2026-09.md` | 🧭 Kỹ năng luận theo chủ đề — SỨC KHỎE · NHÀ ĐẤT · BẠN BÈ/QUÝ NHÂN · ĐI XA |
...
| 1 | 2026-09 | `2026-09.md` | 💰 Đặt nền MoMo — rail thanh toán thứ hai, chưa BẬT |
| 1 | 2026-09 | `2026-09.md` | 💰 Nút "Lưu ảnh QR" — tự điền đủ khi khách chỉ có MỘT điện thoại |
| 1 | 2026-09 | `2026-09.md` | ⚡ Tái cấu trúc tốc độ Đợt 8: 4 trang mới + vá bug thật đã sống từ Đợt 5 (lệch ?v= của tuvi-ansao-engine.js) |
| 1 | 2026-09 | `2026-09.md` | ⚡ Tái cấu trúc tốc độ Đợt 7: 4 trang đầu tiên gọi AiLoadingSteps vào SOFT_PAGES |
| 1 | 2026-09 | `2026-09.md` | 🔒 Vá `ai-loading-steps.js`: lưới an toàn tvmb:softnav cho registry controller |
...
| 1 | 2026-09 | `2026-09.md` | ⚡ Tái cấu trúc tốc độ Đợt 3: thêm 4 trang, phát hiện họ lỗi mới (top-level `let` redeclare) |
...
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 17: mở `INLINE_TOOLS` từ 6 lên 27 tool — `kind:'fields'`/`kind:'draw'` |
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 16: chuyển tool NGAY TRONG rail — không điều hướng trang khi bấm gợi ý |
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 15: cross-sell sản phẩm trong chat — `goi_y_san_pham` + vá `activeTool` sai lệch (giai đoạn 3) |
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 14: concierge engine đoán ý định — Lớp 1 chip điều hướng + Lớp 2 `goi_y_cong_cu` cho kịch bản `hoang-dao` (giai đoạn 2) |
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 13: câu mở đầu trong rail + cửa concierge `/app#chat` (giai đoạn 1) |
| 1 | 2026-09 | `2026-09.md` | 🐛 Chat rail tool "Số Đẹp" luôn báo "kết nối trục trặc" — `scenario.type` thiếu trong cổng validate |
| 1 | 2026-09 | `2026-09.md` | 🩹 Bàn phím ảo iOS Safari che khung nhập chat (`.rail-in`) |
...
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 11: Home `/app` đổi trọng tâm sang hỏi Thầy |
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 10: hội thoại nhập liệu cho 4/5 trang hai-người |
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 9: lan CHATFIRST sang 5 trang hai-người |
| 1 | 2026-09 | `2026-09.md` | 🔄 Chat-first bước 8: lan CHATFIRST sang 3 trang trả-tiền-ngay-lúc-nộp |
...
| 1 | 2026-09 | `2026-09.md` | 🧱 Sprint session thật kiểu ChatGPT/Claude — bước 5: tool-as-agent #2 (Tử Vi Công Sở) |
| 1 | 2026-09 | `2026-09.md` | 🧱 Sprint session thật kiểu ChatGPT/Claude — bước 4: điều tra 2 việc còn treo + pilot tool-as-agent (Tử Bình) |
| 1 | 2026-09 | `2026-09.md` | 🧱 Sprint session thật kiểu ChatGPT/Claude — bước 3: PERSIST `sessionId` qua reload |
...
| 1 | 2026-09 | `2026-09.md` | 🕰️ Gộp công thức giờ→chi về MỘT nguồn — sau khi soát bug "23:45 báo Sửu" của khách |
...
| 1 | 2026-09 | `2026-09.md` | 🗣 GEO/đa dạng topic Vấn Đáp — PR 1+2/6: phát hành /phuong-phap + hub SSR /van-dap |
...
| 1 | 2026-09 | `2026-09.md` | 🔤 Font brand-name Georgia-trần vỡ dấu · logo seal nguyên vẹn · homepage đổi Vận Hôm Nay thành testimonials |
| 1 | 2026-09 | `2026-09.md` | ✍️ Sprint 10 — Giọng §2: Henry chốt không sửa `arcGiong`, giữ nguyên |
| 1 | 2026-09 | `2026-09.md` | 🎨 Sprint 2 phần icon — retune màu gold cũ trên 254 icon-span, không đụng hình dạng |
| 1 | 2026-09 | `2026-09.md` | 🗂 Sprint 9 — Thư viện minh hoạ luận giải: đếm bucket thật, Henry chốt giữ nguyên style |
| 1 | 2026-09 | `2026-09.md` | 🎴 Sprint 8 — Ảnh phụ: khảo sát lật ngược tiền đề, chỉ 4 route OG cần sửa |
| 1 | 2026-09 | `2026-09.md` | 🎨 Sprint 7 — đổi da 25 route SEO server sang bảng màu webtoon |
| 1 | 2026-09 | `2026-09.md` | 🧭 Topnav dùng chung (`nav.js`) vẫn navy — Sprint 2 "phần lớn xong" chưa xong thật |
| 1 | 2026-09 | `2026-09.md` | 🎨 Sprint 6 — đổi da 54 trang tool SEO sang bảng màu webtoon |
...
| 1 | 2026-09 | `2026-09.md` | 🖼 Banner `.intro-card` "che hình" — 2 lỗi CHỒNG NHAU, không phải 1 |
...
| 1 | 2026-09 | `2026-09.md` | 💸 "invalid signature" webhook payOS tái phát SAU khi đã vá checksum key — gốc thật là bug null |
...
| 1 | 2026-09 | `2026-09.md` | 💳 QR chuyển khoản tại chỗ cho khách vô danh khi bấm "Mở khoá" |
...
| 1 | 2026-09 | `2026-09.md` | 🔔 Pop-up "Nạp ngay" trên topup.html cho ý định mở khoá — banner tĩnh dễ bị lướt qua |
| 1 | 2026-09 | `2026-09.md` | 🐛 Mất trắng form sau khi nạp Lượng — lỗ hổng lan RỘNG hơn tưởng: 5 tool nữa |
| 1 | 2026-09 | `2026-09.md` | 🖼️ Chân Dung Vợ Chồng: ảnh dummy sai phong cách + xác nhận lại đường unlock |
