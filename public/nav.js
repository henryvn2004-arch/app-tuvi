...
(function () {
  ...
  var css = [
    ...
    '.nav-link.active{color:#9A7B3A;opacity:1}',
    ...
    '.nav-hamburger{display:none;background:none;border:none;color:#0F2A3D;cursor:pointer;padding:8px;z-index:400;position:relative}',
    ...
    '.nav-links{display:none;position:absolute;top:60px;left:0;right:0;background:#FBFAF6;flex-direction:column;padding:8px 0 16px;gap:0;border-bottom:1px solid #e8e3d8;z-index:199;overflow-y:auto;max-height:calc(100vh - 60px)}',
    ...
    '.nav-dd-item{color:#0F2A3D;padding:9px 36px;border-bottom:1px solid rgba(15,42,61,.05)}',
    '.nav-dd-item:hover{background:rgba(15,42,61,.05);color:#0F2A3D}',
    '.nav-dd-item.active{color:#9A7B3A}',
    '.nav-dd-item .nav-ic{color:#9A7B3A}',
    '.nav-dd-section{background:rgba(200,169,106,.15);color:#9A7B3A;padding:7px 24px 4px}',
    '}'
  ].join('');
  ...
  var footerCss = [
    ...
    '.ft-brand-name{font-size:14px;font-weight:700;color:rgba(255,255,255,0.85);font-family:\'Noto Serif\',Georgia,serif;line-height:1.2}',
    ...
    '.ft-sign span{font-family:\'Noto Serif\',Georgia,serif;font-style:italic;font-size:12.5px;letter-spacing:.02em}',
