...
(function () {
  ...
  // ── Footer ────────────────────────────────────────────────────
  // Footer chỉ chứa nội dung/từ điển/info — KHÔNG lặp tool links đã có trong nav dropdown
  var footerCss = [
  ...
  function injectFooter() {
    var f = '<footer class="site-footer"><div class="ft-body"><div class="ft-top">'
      ...
      // Col 2 — Luận Giải (core pages only, không lặp tool links)
      ...
      // Col 3 — Từ Điển (content pages, not tools)
