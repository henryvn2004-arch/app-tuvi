...
const ACTIONS = [
  ...
  { action: 'vừa phân tích diện tướng khuôn mặt',    page: '/app/dien-tuong' },
  { action: 'vừa xem nhãn tướng đôi mắt',            page: '/app/nhan-tuong' },
  { action: 'vừa luận giải thanh tướng giọng nói',   page: '/app/thanh-tuong' },
  { action: 'vừa xem khí sắc vận trình 1–3 tháng',  page: '/tools/khi-sac-ai.html' },
  { action: 'vừa xem thủ tướng chỉ tay',             page: '/app/thu-tuong' },
