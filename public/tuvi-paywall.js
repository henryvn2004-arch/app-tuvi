...
const TuviPaywall = (() => {
  ...
  const PRODUCTS = {
    ...
    'thanh-tuong': { cost:   8, title: 'Thanh Tướng AI' },
    'thanh-tuong-pro': { cost: 10, title: 'Thanh Tướng Pro' },
    'khi-sac':     { cost:  15, title: 'Khí Sắc — Vận Khí' },
    'phong-thuy':          { cost:  40, title: 'Phong Thủy Nội Thất' },
    'ban-lam-viec':        { cost:  30, title: 'Phong Thủy Bàn Làm Việc' },
    'cua-hang-phong-thuy': { cost:  40, title: 'Phong Thủy Cửa Hàng & VP' },
    'mau-sac-hop-menh':    { cost:  10, title: 'Màu Sắc Hợp Mệnh' },
    'kieu-toc-phan-tich':  { cost:   5, title: 'Phân Tích Kiểu Tóc AI' },
    'kieu-toc-tryon':      { cost:  15, title: 'Thử Kiểu Tóc AI' },
    'trang-phuc-tryon':    { cost:  15, title: 'Thử Trang Phục AI' },
    'phong-thuy-render':   { cost:  30, title: 'Render Phòng Phong Thủy AI' },
    'trang-diem-phan-tich':{ cost:   5, title: 'Phân Tích Trang Điểm AI' },
    'trang-diem-tryon':    { cost:  15, title: 'Thử Trang Điểm AI' },
    ...
    'personal-color-tryon':{ cost:  15, title: 'Personal Color Try-on' },
