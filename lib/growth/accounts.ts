...
const SEED_ACCOUNTS: SeedAccount[] = [
  ...
  { platform: 'smithery', label: 'Smithery (MCP registry)', category: 'registry', priority: 3, same_as: false,
    submit_url: 'https://smithery.ai/', automation: 'Đăng ký 1 lần.', notes: '✅ MCP đã sẵn: /mcp (không key), tài liệu /mcp-server. Nộp URL streamable-http.' },
  { platform: 'mcp-so', label: 'mcp.so', category: 'registry', priority: 3, same_as: false,
    submit_url: 'https://mcp.so/', automation: 'Đăng ký 1 lần.',
    notes: '✅ MCP đã sẵn: /mcp. Dán URL + link /mcp-server.' },
  { platform: 'pulsemcp', label: 'PulseMCP', category: 'registry', priority: 3, same_as: false,
    ...
    notes: '✅ MCP đã sẵn: /mcp. Nộp form, trỏ /mcp-server.' },
  { platform: 'glama-mcp', label: 'Glama MCP Directory', category: 'registry', priority: 2, same_as: false,
    ...
    notes: '✅ MCP đã sẵn: /mcp. Trỏ /mcp-server.' },
  { platform: 'mcp-servers-repo', label: 'GitHub — modelcontextprotocol/servers', category: 'registry', priority: 3, same_as: false,
    ...
    notes: 'Repo chính thức, DA rất cao. Đọc kỹ tiêu chí nhận trước khi gửi PR. ✅ MCP đã sẵn: /mcp.' },
  { platform: 'mcp-registry', label: 'MCP Registry chính thức (registry.modelcontextprotocol.io)', category: 'registry', priority: 3, same_as: false,
    submit_url: 'https://github.com/modelcontextprotocol/registry', automation: 'Publish bằng CLI 1 lần.',
    notes: '✅ Đã có `server.json` ở gốc repo, ĐÃ đối chiếu schema 2025-12-11 (10/10). 📏 Đo 23/08/26: tuvi=0, zodiac=0, astrology=5 nhưng CẢ 5 đều Vedic ⇒ chỗ trống thật. ⚠️ NHƯNG lịch âm VN thì com.am-lich đã có — nộp với định vị TỬ VI, đừng nhận là server lịch âm đầu tiên.' },
  { platform: 'public-apis', label: 'GitHub — public-apis/public-apis', category: 'registry', priority: 3, same_as: false,
    ...
    notes: '✅ API đã sẵn: /api-docs. Gửi PR thêm 1 dòng vào mục Calendar — ô Auth để "No", CORS "Yes". Danh mục đó gần như KHÔNG có lịch âm Việt, đây là chỗ trống thật chứ không phải chen vào hàng đông.' },
  { platform: 'freepublicapis', label: 'Free Public APIs', category: 'registry', priority: 2, same_as: false,
    submit_url: 'https://www.freepublicapis.com/', automation: 'Nộp form 1 lần.',
    notes: 'Danh bạ còn sống, nhận API không cần key. Dán thẳng /api-docs.' },
  { platform: 'apis-guru', label: 'APIs.guru (OpenAPI directory)', category: 'registry', priority: 1, same_as: false,
    submit_url: 'https://github.com/APIs-guru/openapi-directory', automation: 'Gửi PR 1 lần.',
    notes: 'CHỈ nhận API có spec máy đọc được — đã có: /api/public/v1/openapi.json.' },
  { platform: 'rapidapi', label: 'RapidAPI Hub', category: 'registry', priority: 2, same_as: false,
    ...
    notes: 'Nhập bằng file OpenAPI có sẵn: /api/public/v1/openapi.json.' },
